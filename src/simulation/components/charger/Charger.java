...
implements	EmbeddingComponentStateAccessI{
	...
	public			Charger() throws Exception
	{
	...
	protected Charger(String reflectionInboundPortURI) throws Exception
	{
	...
	public Object getEmbeddingComponentStateValue(String name) throws Exception {
		return this.asp.getModelStateValue(ChargerModel.URI, "mode") + " " + 
			   this.asp.getModelStateValue(ChargerModel.URI, "consumption");
	}
	...
	public void			execute() throws Exception
	{
		...
		/*for (int i = 0 ; i < 100 ; i++) {
			this.logMessage("Charger " +
				this.asp.getModelStateValue(ChargerModel.URI, "mode") + " " + 
			    this.asp.getModelStateValue(ChargerModel.URI, "consumption"));
			Thread.sleep(5L) ;
		}*/
	}
