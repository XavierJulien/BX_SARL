...
implements	EmbeddingComponentStateAccessI
{
	...
	protected HeatSensor() throws Exception{
	...
	protected HeatSensor(String reflectionInboundPortURI) throws Exception{
	...
	public Object getEmbeddingComponentStateValue(String name) throws Exception{
		return this.asp.getModelStateValue(HeatSensorModel.URI, "wind");
	}
