...
/**
 * The class <code>WindTurbineUpdaterModel</code> implements a simple user simulation
 * model for the wind turbine.
 *
 * <p><strong>Description</strong></p>
 * 
 * <p>
 * The model is meant to send an updater event to the wind turbine so it can update it's values.
 * </p>
 * 
...
public class WindTurbineUpdaterModel extends AtomicES_Model{
	...
	/**
	 * create a wind turbine updater model instance.
	 * 
